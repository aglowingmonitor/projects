...
<html>
	...
	<head>
		<title>Create Submission - Furworld</title>
	...
	<header>
		<div class="header_wrapper">
			...
			<a href="javascript:void(0);" onclick="openAccountPage()"><img id="fw_userimg" class="fw_userimg" alt="Avatar" src="<?php if (isset($_SESSION['displaypicture'])){ echo $_SESSION['displaypicture']; }else echo "https://cdn.pixelsworld.uk/img_src/defaultavi.jpg";?>"></a>
		</div>
		
		<div id="fw_accountpage" class="fw_accountpage">
			<img class="fw_accountpage-DisplayImage" alt="Avatar" src="<?php if (isset($_SESSION['displaypicture'])){ echo $_SESSION['displaypicture']; }else echo "../src/img/defaultavi.jpg";?>">
	...
	<body>
		<div class="fw_uploadfield hide">
			<form action="../includes/upload_imgsubmission.php" method="post">
				...
				<p class="fw_errormsg">Error: File not a PNG/JPG/GIF!</p>
			</form>
		</div>
		...
		<div class="fw_publishsection">
			<form action="../includes/createsubmission.php">
				...
				<br>
				<h2 class="fw_title"><input class="nsfwcheck" type="checkbox" name="nsfw">This submission is NSFW (18+)</h2>
				<h2 class="fw_title">Warning: If your content is NSFW but not marked as so, it will be removed</h2>
			</form>
